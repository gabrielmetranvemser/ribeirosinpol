...
export function Compartilhar({ siteUrl }: { siteUrl: string }) {
  ...
  return (
    <Secao id="compartilhar" fundo="branco">
      {/* ⚠️ ERA `rounded-[2rem]`, e era a única superfície grande e
          arredondada do site público. A forma deste projeto é o
          CHANFRO — canto cortado a 45° —, e ele está em botão, cartão,
          foto e na primeira dobra. Um painel de canto redondo no meio
          disso não lê como variação, lê como peça de outro kit. */}
      <div className="relative isolate overflow-hidden chanfro-lg fundo-verde p-8 text-white md:p-14">
        <div className="grid gap-10 lg:grid-cols-[1fr_auto] lg:items-center">
          ...
          <div data-revelar className="flex flex-col gap-3 sm:flex-row lg:flex-col">
            <a
              ...
              className="inline-flex min-h-14 items-center justify-center gap-2.5 chanfro bg-amarelo px-8 text-lg font-semibold text-azul-escuro transition-colors duration-300 hover:bg-[color-mix(in_srgb,var(--color-amarelo)_88%,white)]"
            >
